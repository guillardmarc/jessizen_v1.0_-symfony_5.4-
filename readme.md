...
### Partie "Author" (Dépôt GITHub : Fait)
1. Modification du controller "**Articles**"
    ...
    1. Création de la partie commentaire (Etat : Fait)
    1. Réalisation des design des templates (Etat : Fait)

### Partie "Admin" (Dépôt GITHub : )
1. Crud "**Users**" (Etat : Fait)
    1. Modification de la fontion "**listUsers**" (Etat : Fait)
    1. Suppression de la fonction "**new**" (Etat : Fait)
    1. Modification de la fonction "**editUsers**" (Etat : Fait)
    1. Modification de la fonction "**deletUsers**" (Etat : Faite)
    1. Modification de la fonction "**showUser**" (Etat : Fait)
    1. Réalisation des design des template (Etat : Fait)
1. Crud "**Categories**" (Etat : Fait)
    1. Modification de la fonction "**listCategories**" (Etat : Fait)
    1. Modification de la fonction "**newCategories**" (Etat : Fait)
    1. Modification de la fonction "**editCategories**" (Etat : Fait)
    1. Modification de la fonction "**deletCategories**" (Etat : Fait)
    1. Modification de la fonction "**showCategories**" (Etat : Fait)
    1. Réalisation des design des template (Etat : Fait)
1. Crud "**Websites**" (Etat : Fait)
    1. Modification de la fonction "**listWebsites**" (Etat : Fait)
    1. Modification de la fonction "**newWebsites**" (Etat : Fait)
    1. Modification de la fonction "**editWebsites**" (Etat : Fait)
    1. Modification de la fonction "**deletWebsites**" (Etat : Fait)
    1. Modification de la fonction "**showWebsites**" (Etat : Fait)
    1. Création de la fonction "**deleteImageLogo**" (Etat : Fait)
    1. Création de la fonction "**deleteImagePresentation**" (Etat : Fait)
    1. Réalisation des design des template (Etat : Fait)
1. Crud "**WebsitesUpdates**" (Etat : Fait)
    1. Modification de la fonction "**listWebsitesUpdates**" (Etat : Fait)
    1. Modification de la fonction "**newWebsitesUpdates**" (Etat : Fait)
    1. Modification de la fonction "**editWebsitesUpdates**" (Etat : Fait)
